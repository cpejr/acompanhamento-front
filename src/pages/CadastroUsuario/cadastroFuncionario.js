    ...
    <div>
      <form className={classes.allforms} onSubmit={() => handleSubmit("cadastroFuncionario")}>
        <Grid className={classes.formulario}>
          <TextField className={classes.campodeinfo} value={formData.nome} name="nome" onChange={handleChangeInput} label="Nome Completo" type="text" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.cpf} name="cpf" onChange={handleChangeInput} label="CPF" type="text" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.nascimento} name="nascimento" onChange={handleChangeInput} label="Data de nascimento" type="date" helperText="(Opcional)" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.telefone} name="telefone" onChange={handleChangeInput} label="Número de telefone" type="number" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.situacao} name="situacao" onChange={handleChangeInput} label="Situação" type="text" helperText="*Obrigatório" variant="filled" />
          <div>
