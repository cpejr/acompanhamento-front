    ...
    <div>
      <form className={classes.allforms} onSubmit={() => handleSubmit("cadastroPJ")}>
        <Grid className={classes.formulario}>
          <TextField className={classes.campodeinfo} value={formData.nomeEmpresa} label="Nome da empresa" name="nomeEmpresa" onChange={handleChangeInput} type="text" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.cnpj} label="CNPJ" name="cnpj" onChange={handleChangeInput} type="text" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.razaoSocial} label="Razão Social" name="razaoSocial" onChange={handleChangeInput} type="text" helperText="*Obrigatório" variant="filled" />
          <TextField className={classes.campodeinfo} value={formData.inscricaoEstadual} label="Inscrição Estadual" name="inscricaoEstadual" onChange={handleChangeInput} type="text" helperText="*Obrigatório" variant="filled" />
